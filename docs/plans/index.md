...
| 2026-09-03 | [Library API, missing verbs, and the shakenfist.k3s collection](library-api-and-collection.md) | Make the orchestration callable from Python, add the verbs a daemon needs, and ship an optional Ansible collection for cluster bringup | In progress | 1. [Library API](library-api-and-collection-phase-01-library-api.md), 2. [Client construction](library-api-and-collection-phase-02-client-construction.md), 3. Missing verbs, 4. First release, 5. The collection, 6. Push audit |
